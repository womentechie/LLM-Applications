...
pages = {
    ...
    # ── Embedding demos ───────────────────────────────────────
    # NOTE: 01_embed_similarity.py lives here but may require its own
    # embedding key if it uses embeddings_utils. Add get_or_set_embedding_key()
    # to app.py above if you enable this page.
    # "🔢 Embeddings": [
    ...
    "🖼️ Image Processing": [
        ...
        st.Page("pages/21_kyc_verification.py", title="KYC Verification", icon="🖼️"),
        st.Page("pages/22_product_verification.py", title="Product Comparison", icon="🖼️"),
    ],

    # ── Coming soon — uncomment as you build each page ────────
    # "🖼️ Advanced Vision": [
    #     st.Page("pages/21_batch_image_describe.py",  title="Batch Description", icon="🗂️"),
    #     st.Page("pages/22_image_rag.py",             title="Image + Doc RAG",   icon="🔍"),
    #     st.Page("pages/23_image_classify.py",        title="Classification",    icon="🏷️"),
    # ],
